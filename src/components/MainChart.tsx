...
export default function MainChart({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-10 gap-4 md:gap-6 w-full h-full">
      <Card className="w-full h-72 md:col-span-7 mb-6 md:mb-0">
        <CardHeader>
      ...
      <Card className="w-full h-72 md:col-span-3 rounded-0 shadow-none">
        <CardContent>
          {walletData ? (
